...
<body style="font-family: Arial; font-size: smaller;">
	...
	<table bgcolor="grey" width="750" height="500" align="center"
		...
		<tr valign="top" align="center">
			<td align="center"><form:form action="updateCustomer.do"
					method="post" commandName="editCustomer">
					<table width="500" style="border-collapse: collapse;" border="0"
						...
						<tr valign="bottom">
							<td colspan="3" align="center"><input type="button"
								value="Delete"
								onclick="javascript:deleteCustomer('deleteCustomer.do?id=${editCustomer.id}');">
								&nbsp;&nbsp; <input type="submit" name="" value="Save">
								&nbsp;&nbsp; <input type="button" value="Back"
								onclick="javascript:go('viewAllCustomers.do');"></td>
						</tr>
